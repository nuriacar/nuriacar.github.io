---
layout: post
title:  SimSpace Cyber Range Platform
...
**[SimSpace](https://www.simspace.com/)** company is the first organisation to develop this new "product covering all products". The company founders adapted the [Red Flag](https://en.wikipedia.org/wiki/Exercise_Red_Flag) exercise organised by the [USAF](https://en.wikipedia.org/wiki/United_States_Air_Force) at [Nellis Base](https://www.nellis.af.mil/About/High-End-Training/Red-Flag-Nellis/) to the virtual world.
...
+ The improvement of the above gives you an optimised cyber resilience; The efficiency of your organisation increases.
...
+ **Cloud Systems Readiness**: You can develop and evaluate your data center capabilities, optimise and extend them to cloud infrastructures.
